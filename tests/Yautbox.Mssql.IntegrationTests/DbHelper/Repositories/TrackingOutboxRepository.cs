...
namespace Yautbox.Mssql.IntegrationTests.DbHelper.Repositories;

internal sealed class TrackingOutboxRepository : IMssqlOutboxRepository
{
    private readonly IMssqlOutboxRepository _innerRepository;
    private readonly OutboxDbHelper _outboxDbHelper;

    public TrackingOutboxRepository(IMssqlOutboxRepository innerRepository, OutboxDbHelper outboxDbHelper)
    {
